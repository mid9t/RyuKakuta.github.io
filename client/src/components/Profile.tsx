    ...
    <section className="mb-12">
      <div className="flex flex-col md:flex-row gap-8">
        <div className="w-full md:w-2/3">
          ...
          <p className="mb-4">
          Born and raised in the suburbs of Tokyo and spending winters and summers at my grandmother's house in Nagano, Japan, 
          ...
          <p className="mb-4">
            ...
            I am <span className="text-primary">energetic</span>, <span className="text-primary">active</span>, 
            and <span className="text-primary"> full of new ideas</span>, which allow me to adapt and adjust to different situations, 
          ...
          <p className="mb-4">
            ...
            <span className="text-primary">Public Sector</span>. I take an interdisciplinary approach to 
            various challenges —from classic classification tasks to traffic prediction—
            by integrating ML and data science applications with insights from economics,
          ...
          <p className="mb-4">
            ...
            where I leveraged LLM capabilities via LangChain to break down complex queries, 
            reducing redundant processing by 28% and optimizing system efficiency. 
          ...
          tackling issues such as predictive modeling for housing valuation in Cook County 
          and real-time traffic estimation for the Bay Bridge in San Francisco. These experiences 
          ...
          merge analytical rigor with human-centered solutions, ensuring that data science serves 
